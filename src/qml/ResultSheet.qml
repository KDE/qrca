    ...
    header: Kirigami.Heading {
        text: {
            ...
            case QrCodeContent.Text:
                return i18nc("Barcode scanned", "Text found");
            case QrCodeContent.Url:
                return i18nc("Barcode scanned", "URL found");
            case QrCodeContent.VCard:
                return i18nc("Barcode scanned", "Contact found");
            case QrCodeContent.OtpToken:
                return i18nc("Barcode scanned", "OTP URI found");
            case QrCodeContent.Binary:
                return i18nc("Barcode scanned", "Binary data found");
            case QrCodeContent.HealthCertificate:
                return i18nc("Barcode scanned", "Health certificate found");
            case QrCodeContent.TransportTicket:
                return i18nc("Barcode scanned, train/flight ticket found", "Transport ticket found");
            case QrCodeContent.ISBN:
                return i18nc("Barcode scanned", "ISBN found");
            case QrCodeContent.EAN:
                return i18nc("Barcode scanned, EAN found", "International Article Number found");
            case QrCodeContent.WifiSetting:
                return i18nc("Barcode scanned", "Wi-Fi settings found");
            default:
                return "";
            }
        }
    ...
    footer: RowLayout {
        ...
        Controls.Button {
            text: {
                switch (resultSheet.tag?.contentType) {
                case QrCodeContent.Url:
                    return i18nc("@action:button", "Open");
                case QrCodeContent.VCard:
                    return i18nc("@action:button", "Save Contact");
                case QrCodeContent.OtpToken:
                    return i18nc("@action:button", "Open OTP client");
                case QrCodeContent.EAN:
                    return i18nc("@action:button", "Open Food Facts");
                case QrCodeContent.ISBN:
                    return i18nc("@action:button", "Wikipedia Book Sources");
                case QrCodeContent.TransportTicket:
                    return i18nc("@action:button", "Open KDE Itinerary");
                case QrCodeContent.HealthCertificate:
                    return i18nc("@action:button", "Open in Vakzination");
                case QrCodeContent.WifiSetting:
                    return i18nc("@action:button", "Connect");
                default:
                    return "";
                }
            }
